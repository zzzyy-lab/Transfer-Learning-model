...
def load_checkpoint(path: str,
    ...
    # Uncomment these lines if you want to move the model to CUDA
    if cuda:
        debug('Moving model to cuda')
        model = model.cuda()

    #Uncomment these lines if you want to freeze certain parameters
    ...
    for name, param in model.named_parameters():
        debug(f"{name}: requires_grad={param.requires_grad}")
